...
<?php if (DISPLAY_PRIVACY_CONDITIONS == 'true') echo '  if (form.elements["privacy_conditions"].checked != true){ error = true; error_message = error_message + "* " + "'. ERROR_PRIVACY_STATEMENT_NOT_ACCEPTED . '" + "\n";}' . "\n"; ?>
