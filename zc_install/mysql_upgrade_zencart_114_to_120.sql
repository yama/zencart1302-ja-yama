...
DELETE FROM products_options_types WHERE language_id='2'
...
#####################################
###### UPDATE JAPANESE ZONES FORMAT #
#####################################
UPDATE zones SET zone_code='ÀÃ≥§∆ª' WHERE zone_country_id='107' AND zone_code='01' AND zone_name='ÀÃ≥§∆ª';
UPDATE zones SET zone_code='¿ƒøπ∏©' WHERE zone_country_id='107' AND zone_code='02' AND zone_name='¿ƒøπ∏©';
UPDATE zones SET zone_code='¥‰ºÍ∏©' WHERE zone_country_id='107' AND zone_code='03' AND zone_name='¥‰ºÍ∏©';
UPDATE zones SET zone_code='µ‹æÎ∏©' WHERE zone_country_id='107' AND zone_code='04' AND zone_name='µ‹æÎ∏©';
UPDATE zones SET zone_code='Ω©≈ƒ∏©' WHERE zone_country_id='107' AND zone_code='05' AND zone_name='Ω©≈ƒ∏©';
UPDATE zones SET zone_code='ª≥∑¡∏©' WHERE zone_country_id='107' AND zone_code='06' AND zone_name='ª≥∑¡∏©';
UPDATE zones SET zone_code=' °≈Á∏©' WHERE zone_country_id='107' AND zone_code='07' AND zone_name=' °≈Á∏©';
UPDATE zones SET zone_code='∞ÒæÎ∏©' WHERE zone_country_id='107' AND zone_code='08' AND zone_name='∞ÒæÎ∏©';
UPDATE zones SET zone_code='∆ Ã⁄∏©' WHERE zone_country_id='107' AND zone_code='09' AND zone_name='∆ Ã⁄∏©';
UPDATE zones SET zone_code='∑≤«œ∏©' WHERE zone_country_id='107' AND zone_code='10' AND zone_name='∑≤«œ∏©';
UPDATE zones SET zone_code='∫Î∂Ã∏©' WHERE zone_country_id='107' AND zone_code='11' AND zone_name='∫Î∂Ã∏©';
UPDATE zones SET zone_code='¿ÈÕ’∏©' WHERE zone_country_id='107' AND zone_code='12' AND zone_name='¿ÈÕ’∏©';
UPDATE zones SET zone_code='≈Ïµ˛≈‘' WHERE zone_country_id='107' AND zone_code='13' AND zone_name='≈Ïµ˛≈‘';
UPDATE zones SET zone_code='ø¿∆‡¿Ó∏©' WHERE zone_country_id='107' AND zone_code='14' AND zone_name='ø¿∆‡¿Ó∏©';
UPDATE zones SET zone_code='ø∑≥„∏©' WHERE zone_country_id='107' AND zone_code='15' AND zone_name='ø∑≥„∏©';
UPDATE zones SET zone_code='…Ÿª≥∏©' WHERE zone_country_id='107' AND zone_code='16' AND zone_name='…Ÿª≥∏©';
UPDATE zones SET zone_code='¿–¿Ó∏©' WHERE zone_country_id='107' AND zone_code='17' AND zone_name='¿–¿Ó∏©';
UPDATE zones SET zone_code=' °∞Ê∏©' WHERE zone_country_id='107' AND zone_code='18' AND zone_name=' °∞Ê∏©';
UPDATE zones SET zone_code='ª≥Õ¸∏©' WHERE zone_country_id='107' AND zone_code='19' AND zone_name='ª≥Õ¸∏©';
UPDATE zones SET zone_code='ƒπÃÓ∏©' WHERE zone_country_id='107' AND zone_code='20' AND zone_name='ƒπÃÓ∏©';
UPDATE zones SET zone_code='¥Ù…Ï∏©' WHERE zone_country_id='107' AND zone_code='21' AND zone_name='¥Ù…Ï∏©';
UPDATE zones SET zone_code='¿≈≤¨∏©' WHERE zone_country_id='107' AND zone_code='22' AND zone_name='¿≈≤¨∏©';
UPDATE zones SET zone_code='∞¶√Œ∏©' WHERE zone_country_id='107' AND zone_code='23' AND zone_name='∞¶√Œ∏©';
UPDATE zones SET zone_code='ª∞Ω≈∏©' WHERE zone_country_id='107' AND zone_code='24' AND zone_name='ª∞Ω≈∏©';
UPDATE zones SET zone_code='º¢≤Ï∏©' WHERE zone_country_id='107' AND zone_code='25' AND zone_name='º¢≤Ï∏©';
UPDATE zones SET zone_code='µ˛≈‘…‹' WHERE zone_country_id='107' AND zone_code='26' AND zone_name='µ˛≈‘…‹';
UPDATE zones SET zone_code='¬Á∫Â…‹' WHERE zone_country_id='107' AND zone_code='27' AND zone_name='¬Á∫Â…‹';
UPDATE zones SET zone_code=' º∏À∏©' WHERE zone_country_id='107' AND zone_code='28' AND zone_name=' º∏À∏©';
UPDATE zones SET zone_code='∆‡Œ…∏©' WHERE zone_country_id='107' AND zone_code='29' AND zone_name='∆‡Œ…∏©';
UPDATE zones SET zone_code='œ¬≤Œª≥∏©' WHERE zone_country_id='107' AND zone_code='30' AND zone_name='œ¬≤Œª≥∏©';
UPDATE zones SET zone_code='ƒªºË∏©' WHERE zone_country_id='107' AND zone_code='31' AND zone_name='ƒªºË∏©';
UPDATE zones SET zone_code='≈Á∫¨∏©' WHERE zone_country_id='107' AND zone_code='32' AND zone_name='≈Á∫¨∏©';
UPDATE zones SET zone_code='≤¨ª≥∏©' WHERE zone_country_id='107' AND zone_code='33' AND zone_name='≤¨ª≥∏©';
UPDATE zones SET zone_code='π≠≈Á∏©' WHERE zone_country_id='107' AND zone_code='34' AND zone_name='π≠≈Á∏©';
UPDATE zones SET zone_code='ª≥∏˝∏©' WHERE zone_country_id='107' AND zone_code='35' AND zone_name='ª≥∏˝∏©';
UPDATE zones SET zone_code='∆¡≈Á∏©' WHERE zone_country_id='107' AND zone_code='36' AND zone_name='∆¡≈Á∏©';
UPDATE zones SET zone_code='π·¿Ó∏©' WHERE zone_country_id='107' AND zone_code='37' AND zone_name='π·¿Ó∏©';
UPDATE zones SET zone_code='∞¶…≤∏©' WHERE zone_country_id='107' AND zone_code='38' AND zone_name='∞¶…≤∏©';
UPDATE zones SET zone_code='π‚√Œ∏©' WHERE zone_country_id='107' AND zone_code='39' AND zone_name='π‚√Œ∏©';
UPDATE zones SET zone_code=' °≤¨∏©' WHERE zone_country_id='107' AND zone_code='40' AND zone_name=' °≤¨∏©';
UPDATE zones SET zone_code='∫¥≤Ï∏©' WHERE zone_country_id='107' AND zone_code='41' AND zone_name='∫¥≤Ï∏©';
UPDATE zones SET zone_code='ƒπ∫Í∏©' WHERE zone_country_id='107' AND zone_code='42' AND zone_name='ƒπ∫Í∏©';
UPDATE zones SET zone_code='∑ßÀ‹∏©' WHERE zone_country_id='107' AND zone_code='43' AND zone_name='∑ßÀ‹∏©';
UPDATE zones SET zone_code='¬Á ¨∏©' WHERE zone_country_id='107' AND zone_code='44' AND zone_name='¬Á ¨∏©';
UPDATE zones SET zone_code='µ‹∫Í∏©' WHERE zone_country_id='107' AND zone_code='45' AND zone_name='µ‹∫Í∏©';
UPDATE zones SET zone_code='ºØª˘≈Á∏©' WHERE zone_country_id='107' AND zone_code='46' AND zone_name='ºØª˘≈Á∏©';
UPDATE zones SET zone_code='≤≠∆Ï∏©' WHERE zone_country_id='107' AND zone_code='47' AND zone_name='≤≠∆Ï∏©';
