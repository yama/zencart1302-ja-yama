#
# * This SQL script upgrades the core Zen Cart database structure from v1.3.0.2 to v1.3.0.2-l10n-jp-1
# *
# * @package Installer
# * @access private
# * @copyright Copyright 2006 Zen Cart.JP
...
INSERT INTO currencies VALUES (3,'Japanese Yen','JPY','','円','.',',','','1.000000', now());
...
INSERT INTO tax_rates (tax_zone_id, tax_class_id, tax_priority, tax_rate, tax_description, date_added) VALUES ('2', '2', '0', '5', '内消費税', now());
INSERT INTO geo_zones (geo_zone_id, geo_zone_name, geo_zone_description, date_added) VALUES (2, '日本', '日本', now());
INSERT INTO zones_to_geo_zones (association_id, zone_country_id, zone_id, geo_zone_id, date_added) VALUES (2, 107, 0, 2, now());
INSERT INTO tax_class (tax_class_id, tax_class_title, tax_class_description, date_added) VALUES ('2', '消費税', '消費税', now());
...
INSERT INTO orders_status VALUES ( '3', '2', '完了');
...
UPDATE configuration SET configuration_title='クッキー使用', configuration_description='クッキーが有効な場合にセッションにクッキーを使用しますか?' WHERE configuration_key='SESSION_FORCE_COOKIE_USE';
...
UPDATE configuration SET configuration_title='新しいクーポン券登録ID', configuration_description='クーポン券を選択してください。' WHERE configuration_key='NEW_SIGNUP_DISCOUNT_COUPON';
...
# メール送信先を翻訳する
UPDATE query_builder SET query_name = '全顧客' WHERE query_id =1 LIMIT 1;
UPDATE query_builder SET query_name = 'メールマガジン希望者' WHERE query_id =2 LIMIT 1;
UPDATE query_builder SET query_name = '休眠顧客（過去三ヶ月間、配信希望者のみ）' WHERE query_id =3 LIMIT 1;
UPDATE query_builder SET query_name = '稼動顧客（過去三ヶ月間、配信希望者のみ）' WHERE query_id =4 LIMIT 1;
UPDATE query_builder SET query_name = '稼動顧客（過去三ヶ月間）' WHERE query_id =5 LIMIT 1;
UPDATE query_builder SET query_name = '管理者' WHERE query_id =6 LIMIT 1;
...
# 性名の逆転
ALTER TABLE customers ADD customers_seimei_tmp varchar(32);
UPDATE customers SET customers_seimei_tmp = customers_lastname, customers_lastname = customers_firstname, customers_firstname = customers_seimei_tmp;
ALTER TABLE customers DROP customers_seimei_tmp;
# バージョン情報の更新
UPDATE project_version SET project_version_minor = '3.0.2-l10n-jp-1' where project_version_id = '1';
UPDATE project_version SET project_version_minor = '3.0.2-l10n-jp-1' where project_version_id = '2';
INSERT INTO project_version_history (project_version_key, project_version_major, project_version_minor, project_version_patch, project_version_comment, project_version_date_applied) VALUES ('Zen-Cart Main', '1', '3.0.2-l10n-jp-1', '', 'v1.3.0.2-l10n-jp-1', now());
INSERT INTO project_version_history (project_version_key, project_version_major, project_version_minor, project_version_patch, project_version_comment, project_version_date_applied) VALUES ('Zen-Cart Database', '1', '3.0.2-l10n-jp-1', '', 'v1.3.0.2-l10n-jp-1', now());
