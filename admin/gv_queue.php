...
//      $gv_amount = $gv_resulta->fields['amount'];
      ...
      //if total_gv_amount is over MAX_GIFT_AMOUNT , update process is canceled
        if($total_gv_amount <= MAX_GIFT_AMOUNT){
...
//send the message
          ...
          $messageStack->add(ERROR_MAX_GIFT_AMOUNT_EXCEEDED, 'error');
        }
      }
    }
  }
