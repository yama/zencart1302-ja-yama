  ...
  if (zen_not_null($action)) {
    switch ($action) {
      ...
      for ($i=0, $n=sizeof($languages); $i<$n; $i++) {
        ...
        $sql_data_array = array('categories_name' => zen_db_prepare_input(mb_strimwidth($categories_name_array[$language_id], 0, zen_field_length(TABLE_CATEGORIES_DESCRIPTION, 'categories_name'))),
